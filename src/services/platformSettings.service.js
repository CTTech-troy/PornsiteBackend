...
export const PLATFORM_SETTINGS_CATALOG = [
  ...
  { key: 'exoclick_vast_tag_url', label: 'ExoClick VAST Tag URL', section: 'Monetization', type: 'url', defaultValue: 'https://s.magsrv.com/v1/vast.php?idzone=5932212', public: true },
  ...
  { key: 'ad_provider_priority_order', label: 'Ad Provider Priority (JSON)', section: 'Monetization', type: 'json', defaultValue: '["monetag","juicyads","exoclick","google_ad_manager"]' },
  ...
  { key: 'ad_allowed_domains', label: 'Allowed Ad Domains (JSON)', section: 'Safe Ads', type: 'json', defaultValue: '["juicyads.com","www.juicyads.com","js.juicyads.com","poweredby.jads.co","jads.co","exoclick.com","magsrv.com","s.magsrv.com","googleads.g.doubleclick.net","securepubads.g.doubleclick.net","googlesyndication.com","quge5.com","monetag.com","www.monetag.com","highperformanceformat.com","profitablecpmrate.com","profitablecpmgate.com","alwingulla.com"]' },
