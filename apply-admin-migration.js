...
try {
  ...
  console.log(`  Option B — POST ${(process.env.BACKEND_PUBLIC_URL || 'https://api.xstreamvideos.site').replace(/\/$/, '')}/api/admin/auth/founder-create`);
...
Create your first super admin by calling:
  ...
  POST ${(process.env.BACKEND_PUBLIC_URL || 'https://api.xstreamvideos.site').replace(/\/$/, '')}/api/admin/auth/founder-create
