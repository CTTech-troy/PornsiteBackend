 ...
 * Usage: BASE_URL=https://api.xstreamvideos.site node scripts/stress-auth.mjs [concurrency] [requests]
 */
const base = (process.env.BASE_URL || 'https://api.xstreamvideos.site').replace(/\/$/, '');
